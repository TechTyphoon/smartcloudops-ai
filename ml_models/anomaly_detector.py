...
class AnomalyDetector:
    ...
    def _get_default_config(self) -> Dict:
        ...
        return {
            "data": {"lookback_hours": 168, "feature_window": 60},
            "training": {"min_f1_score": 0.85},
        }

    def train_model(
        self, force_retrain: bool = False, data: pd.DataFrame = None
    ) -> Dict:
        """
        ...
        try:
            ...
            if not self.model_trainer.meets_quality_threshold(validation_results):
                logger.warning(
                    f"Model quality below threshold: F1={validation_results['f1_score']:.3f}"
                )
                return {
                    "status": "failed",
    ...
    def _is_model_recent(self) -> bool:
        ...
        try:
            ...
            retrain_hours = self.config.get("training", {}).get(
    ...
    def detect_anomaly(self, metrics_data: Dict) -> Dict:
        ...
        try:
            ...
            (
                ...
                severity_score,
                explanation,
            ) = self.inference_engine.detect_anomalies(metrics_data)
            ...
            return {"status": "error", "message": f"Error during detection: {str(e)}"}
    ...
    def get_feature_importance(self) -> Dict:
        ...
        try:
            ...
            return {"feature_count": len(feature_columns), "features": feature_columns}
        except Exception as e:
