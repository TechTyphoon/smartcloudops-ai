...
try:
    ...
    class MockMLflow:
        ...
        @staticmethod
        def set_registry_uri(uri): pass
        @staticmethod
        def set_experiment(name): pass
        @staticmethod
        def start_run(run_name=None, tags=None): return MockMLflow.ActiveRun()
        @staticmethod
        ...
        def end_run(): pass
        @staticmethod
        def log_model(model, artifact_path, **kwargs): pass
        @staticmethod
                ...
                return [
                    {
                        ...
                        "creation_timestamp": getattr(model, 'creation_timestamp', None),
                        "last_updated_timestamp": getattr(model, 'last_updated_timestamp', None)
                    }
                    for model in models
                ]
            except Exception as e:
