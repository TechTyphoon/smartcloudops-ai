...
try:
    ...
    # Create a mock class for testing if the module is not available
    class GPTHandler:
        def __init__(self):
            pass

        def process_query(self, query):
            return {"status": "error", "response": "GPT handler not available"}
...
class TestGPTIntegration:
    ...
    def test_process_query_with_client(self, mock_openai):
        ...
        mock_response.choices[0].message.content = "The CPU usage is 45%"
