...
class TestRealProductionApp:
    ...
    def test_anomaly_batch_detection(self, client):
        ...
        test_data = {"metrics": [{"cpu": 85, "memory": 75}, {"cpu": 20, "memory": 30}]}
    ...
    def test_chatops_analyze_query(self, client):
        ...
        test_data = {"query": "What is the system health status?"}
    ...
    def test_dashboard_loads(self, client):
        ...
        assert (
            b"dashboard_modern.html"
            or b"Smart CloudOps AI - Production Dashboard" in response.data
        )
    ...
    def test_error_handling_invalid_json(self, client):
        ...
        response = client.post(
            "/anomaly/batch", data="invalid json", content_type="application/json"
        )
    ...
    def test_missing_required_fields(self, client):
        ...
        response = client.post(
            "/anomaly/batch", data=json.dumps({}), content_type="application/json"
        )
