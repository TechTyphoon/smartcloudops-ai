...
from ml_models import AnomalyDetector, DataProcessor, AnomalyModelTrainer, AnomalyInferenceEngine
...
class TestDataProcessor:
    ...
    def test_data_validation(self):
        ...
        valid_data = pd.DataFrame({
            'cpu_usage_avg': [30] * 100,  # 100 points
            'memory_usage_pct': [60] * 100
        })
...
class TestInferenceEngine:
    ...
    def test_anomaly_explanation(self):
        ...
        assert 'Anomaly detected' in explanation or 'No anomalies detected' in explanation
