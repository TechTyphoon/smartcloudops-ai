...
class TestMLOpsService:
    ...
    def test_get_experiments_filter_multiple(self):
        ...
        experiments, pagination = self.service.get_experiments(
            status="running", tags=["feature-engineering"]
        )
    ...
    def test_create_experiment_missing_required_fields(self):
        ...
        experiment_data = {"description": "Missing name field"}
    ...
    def test_create_data_transformation_fallback(self):
        ...
        transformations = [
            {
                "type": "filter",
                "params": {"column": "value", "condition": "greater_than", "value": 10},
            }
        ]

        result = self.service.create_data_transformation(
            "source_version_id", transformations, "output_dataset"
        )
    ...
    def test_create_data_transformation_multiple_transforms(self):
        ...
        transformations = [
            ...
            {
                "type": "normalization",
                "params": {"columns": ["col2"], "method": "standard"},
            },
            {
                "type": "outlier_removal",
                "params": {"columns": ["col3"], "method": "iqr"},
            },
        ]

        result = self.service.create_data_transformation(
            "source_version_id", transformations
        )
...
class TestMLOpsServiceEdgeCases:
    ...
    def test_get_experiments_empty_filters(self):
        ...
        experiments, pagination = self.service.get_experiments(status="", tags=None)
    ...
    def test_create_experiment_empty_name(self):
        ...
        experiment_data = {"name": "", "description": "Test description"}
