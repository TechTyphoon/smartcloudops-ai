...
class TestMLOpsAPI(unittest.TestCase):
    ...
    def test_log_metric_valid_data(self):
        ...
        metric_data = {"key": "accuracy", "value": 0.95, "step": 100}
    ...
    def test_log_parameter_valid_data(self):
        ...
        param_data = {"key": "learning_rate", "value": 0.01}
...
class TestMLOpsAPIEdgeCases(unittest.TestCase):
    ...
    def test_invalid_json_data(self):
        ...
        response = self.client.post(
            "/api/mlops/experiments", data=invalid_json, content_type="application/json"
        )
    ...
    def test_empty_request_body(self):
        ...
        response = self.client.post(
            "/api/mlops/experiments", data="", content_type="application/json"
        )
