...
class TestSecurityConfiguration:
    ...
    def test_required_environment_variables(self):
        ...
        required_vars = ["SECRET_KEY", "JWT_SECRET_KEY", "DEFAULT_ADMIN_PASSWORD"]
...
class TestAuthentication:
    ...
    def test_token_with_wrong_secret(self):
        ...
        wrong_token = jwt.encode(
            wrong_secret_payload, "wrong-secret-key", algorithm="HS256"
        )
...
class TestInputValidation:
    ...
    def test_sql_injection_prevention(self):
        ...
        for attempt in sql_injection_attempts:
            ...
            ), f"SQL injection should be blocked: {attempt}"
    ...
    def test_command_injection_prevention(self):
        ...
        for attempt in command_injection_attempts:
            ...
            assert (
                result["is_valid"] is False
            ), f"Command injection should be blocked: {attempt}"
