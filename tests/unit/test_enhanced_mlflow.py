...
class TestMLflowManagerEnhanced:
    ...
    def setup_method(self):
        ...
        self.mlflow_manager.fallback_storage_path = os.path.join(self.temp_dir, "fallback_logs")
    ...
    def test_log_model_params_fallback(self):
        ...
        # Check fallback file was created
        params_file = os.path.join(self.mlflow_manager.fallback_storage_path, "latest_params.json")
    ...
    def test_log_model_metrics_fallback(self):
        ...
        # Check fallback file was created
        metrics_file = os.path.join(self.mlflow_manager.fallback_storage_path, "latest_metrics.json")
    ...
    def test_log_model_artifact_fallback(self):
        ...
        # Check fallback file was created
        artifacts_file = os.path.join(self.mlflow_manager.fallback_storage_path, "artifacts.json")
    ...
    def test_save_model_different_flavors(self):
        ...
        pytorch_uri = self.mlflow_manager.save_model(mock_model, "pytorch_model", "pytorch")
    ...
    def test_register_model_fallback(self):
        ...
        registry_file = os.path.join(self.mlflow_manager.fallback_storage_path, "model_registry.json")
    ...
    def test_register_multiple_model_versions(self):
        ...
        versions = [entry["version"] for entry in registry if entry["name"] == model_name]
...
class TestMLflowManagerEdgeCases:
    ...
    def test_fallback_logging_disabled(self):
        ...
        try:
            ...
            manager.fallback_storage_path = os.path.join(isolated_temp, "isolated_fallback")
    ...
    def test_empty_parameters_and_metrics(self):
        ...
        params_file = os.path.join(self.manager.fallback_storage_path, "latest_params.json")
        metrics_file = os.path.join(self.manager.fallback_storage_path, "latest_metrics.json")
