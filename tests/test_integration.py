...
class TestCompleteWorkflow:
    ...
    def test_complete_ml_to_remediation_workflow(self, client, mock_anomaly_detector, mock_remediation_engine):
    ...
    def test_chatops_with_ml_context(self, client, mock_ai_handler):
        ...
        query_data = {
            "query": "What anomalies were detected recently?"
        }
    ...
    def test_smart_query_with_context(self, client, mock_ai_handler):
        ...
        query_data = {
            "query": "Analyze system health and recent anomalies"
        }
    ...
    def test_data_consistency_across_endpoints(self, client, mock_anomaly_detector):
        ...
        with patch('app.main.anomaly_detector', mock_anomaly_detector):
            ...
            batch_response = client.post('/anomaly/batch', json={"metrics_batch": [test_metrics]})
