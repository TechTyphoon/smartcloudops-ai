...
class DatabaseConfig:
    ...
    SQLALCHEMY_ENGINE_OPTIONS = {
        ...
        'connect_args': {
            'connect_timeout': 10,
            'application_name': 'SmartCloudOps_AI'
        }
    }
    ...
    with app.app_context():
        try:
            ...
            with db.engine.connect() as connection:
                ...
                print(f"✅ Database connection successful: {DatabaseConfig.POSTGRES_DB}")
...
def get_connection_info():
    ...
    return {
        ...
        'uri': DatabaseConfig.SQLALCHEMY_DATABASE_URI.replace(DatabaseConfig.POSTGRES_PASSWORD, '****')
    }
