...
from .health_checks import HealthStatus, health_monitor
...
class MetricCollector:
    ...
    def record_metric(
        self, metric_name: str, value: Any, timestamp: Optional[datetime] = None
    ):
    ...
    def get_metric_history(
        self, metric_name: str, duration_hours: int = 24
    ) -> List[Dict[str, Any]]:
...
class AlertManager:
    ...
    def _is_rate_limited(self, component: str) -> bool:
        ...
        self.rate_limits[component] = [
            timestamp for timestamp in self.rate_limits[component] if timestamp > cutoff
        ]
...
class EmailNotifier:
    ...
    def send_alert(self, alert: Alert):
        ...
        try:
            ...
            msg["Subject"] = (
                f"[{alert.severity.value.upper()}] SmartCloudOps Alert: {alert.title}"
            )
...
class MonitoringDashboard:
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        for metric_name in [
            ...
            stats = self.metric_collector.calculate_metric_stats(
                metric_name, duration_hours=1
            )
            if stats:
    ...
    def _calculate_uptime(self) -> Dict[str, float]:
        ...
        return {"last_hour": 99.5, "last_24h": 99.8, "last_7d": 99.9, "last_30d": 99.95}
