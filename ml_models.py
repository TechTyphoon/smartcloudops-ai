...
class AnomalyDetector:
    ...
    def __init__(self, contamination: float = 0.1, random_state: int = 42):
        ...
        os.makedirs(os.path.dirname(self.model_path) if os.path.dirname(self.model_path) else 'ml_models', exist_ok=True)
    ...
    def prepare_features(self, metrics_data: List[Dict]) -> pd.DataFrame:
        ...
        try:
            ...
            percentage_cols = ['cpu_usage_percent', 'memory_usage_percent', 'disk_usage_percent']
    ...
    def train(self, training_data: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            if features_df.empty or len(features_df) < 10:
                ...
                logger.warning("Using synthetic training data due to insufficient real data")
    ...
    def _generate_synthetic_data(self, n_samples: int) -> pd.DataFrame:
        ...
        normal_data = {
            ...
            'network_bytes_sent_rate': np.random.normal(1000000, 500000, int(n_samples * 0.85)),
            'network_bytes_recv_rate': np.random.normal(2000000, 800000, int(n_samples * 0.85))
        }
        ...
        anomaly_data = {
            ...
            'network_bytes_sent_rate': np.random.uniform(10000000, 50000000, anomaly_samples),
                ...
                if col in df.columns and not df[col].empty:
                    ...
                    if len(values) >= 3:
                        ...
                        trends[col] = {
                            ...
                            'change_rate': float(slope / values.mean()) if values.mean() != 0 else 0
                        }
