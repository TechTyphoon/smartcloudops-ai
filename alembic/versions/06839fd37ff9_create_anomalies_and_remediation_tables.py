...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("critical", "major", "minor", "info", name="anomalyseverity"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum(
                "active", "acknowledged", "resolved", "dismissed", name="anomalystatus"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum(
                "restart", "scale", "cleanup", "config", name="remediationcategory"
            ),
            nullable=False,
        ),
        sa.Column(
            "severity",
            sa.Enum("low", "medium", "high", "critical", name="remediationseverity"),
            nullable=False,
        ),
