...
def check_environment():
    ...
    if ai_provider == 'openai' or (ai_provider == 'auto' and openai_key):
        ...
        print("⚠️  No AI provider API keys configured. AI functionality will be disabled.")
        print("   To enable AI: Set OPENAI_API_KEY or GEMINI_API_KEY environment variable")
