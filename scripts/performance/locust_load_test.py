...
class SmartCloudOpsUser(HttpUser):
                ...
                if response.status_code in [200, 201]:
                    ...
                    with self.client.post(
                        ...
                        if login_response.status_code == 200:
                            ...
                            self.user_id = (
                                login_response.json().get("user", {}).get("id")
                            )
    ...
    def ml_model_info(self):
        ...
        self.client.get(
            "/api/ml/model/info", headers=self.auth_headers, name="ML - Model Info"
        )
    ...
    def create_remediation_action(self):
        ...
        action_data = {
            "action_type": random.choice(
                ["restart_service", "scale_up", "scale_down", "send_alert"]
            ),
    ...
    def submit_feedback(self):
        ...
        feedback_data = {
            ...
            "category": random.choice(
                ["anomaly_detection", "remediation", "ui", "performance"]
            ),
    ...
    def bulk_anomaly_analysis(self):
        ...
        bulk_data = {
            ...
            "parameters": {"threshold": 0.8, "algorithm": "isolation_forest"},
        }
        ...
        with self.client.post(
            ...
            if response.elapsed.total_seconds() > 10:
                logger.warning(
                    f"Slow bulk analysis: {response.elapsed.total_seconds()}s"
                )
...
if __name__ == "__main__":
    ...
    cmd = [
        ...
        "60s",
        "--html",
        "docs/results/load-test-report.html",
    ]
