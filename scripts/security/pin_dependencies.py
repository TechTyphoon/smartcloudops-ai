...
""".format(sys.version.split()[0])
        ...
        print(f"   - Use 'pip install --require-hashes -r requirements.lock' for secure installation")
...
def main():
    ...
    if pin_dependencies():
        ...
        print("2. Update Dockerfile to use: pip install --require-hashes -r requirements.lock")
