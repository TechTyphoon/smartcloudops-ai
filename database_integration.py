...
from models import (
    SystemMetrics, MLTrainingData, AnomalyDetection, 
    RemediationAction, ChatOpsInteraction, HealthCheck, SecurityScan
)
...
class DatabaseService:
    ...
    def get_metrics_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            ).filter(SystemMetrics.timestamp >= since).first())
            ...
            if result:
                return {
                    ...
                    'disk_stats': {
                        'average_percent': round(result.avg_disk or 0, 2)
                    }
                }
            return {}
        except SQLAlchemyError as e:
    ...
    def get_training_data_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            anomaly_counts = (self.session.query(
                MLTrainingData.anomaly_label,
                func.count().label('count')
            ).group_by(MLTrainingData.anomaly_label).all())
            
            return {
                'total_records': total_records,
                'anomaly_distribution': {label: count for label, count in anomaly_counts},
    ...
    def get_active_anomalies(self) -> List[Dict[str, Any]]:
        ...
        try:
            anomalies = (self.session.query(AnomalyDetection)
    ...
    def get_health_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            latest_checks = (self.session.query(HealthCheck)
    ...
    # ChatOps Operations
    def store_chatops_interaction(self, interaction_data: Dict[str, Any]) -> Optional[int]:
    ...
    def get_chatops_history(self, limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            interactions = (self.session.query(ChatOpsInteraction)
    ...
    def get_latest_security_status(self) -> Dict[str, Any]:
        ...
        try:
            latest_scan = (self.session.query(SecurityScan)
    ...
    def cleanup_old_data(self, days: int = 30) -> Dict[str, int]:
        ...
        try:
            ...
            deleted_metrics = (self.session.query(SystemMetrics)
            ...
            deleted_health = (self.session.query(HealthCheck)
