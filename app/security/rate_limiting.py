...
class RateLimiter:
    ...
    def _get_rate_limit_key(self, identifier: str, window: str, endpoint: str = "default") -> str:
    ...
    def _check_rate_limit(
        ...
        try:
            ...
            return True, {"allowed": True, "reason": "rate_limit_error", "error": str(e)}
    ...
    def get_rate_limit_info(self, identifier: str, endpoint: str = "default") -> Dict[str, Union[int, int, str]]:
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            try:
                ...
                # Check rate limit
                allowed, result = rate_limiter.check_and_increment(identifier, endpoint, custom_limits)
...
def rate_limit_by_ip(endpoint: str = "default", custom_limits: Optional[Dict[str, int]] = None):
...
def rate_limit_by_user(endpoint: str = "default", custom_limits: Optional[Dict[str, int]] = None):
...
def rate_limit_by_role(endpoint: str = "default", custom_limits: Optional[Dict[str, int]] = None):
...
class RateLimitMonitor:
                ...
                if len(parts) >= 5:
                    ...
                    if timestamp >= start_time:
                        ...
                        if identifier not in stats["identifiers"]:
                            stats["identifiers"][identifier] = {"requests": 0, "limited": 0}
    ...
    def get_top_offenders(self, limit: int = 10) -> List[Dict[str, any]]:
        ...
        try:
            ...
            sorted_offenders = sorted(offender_counts.items(), key=lambda x: x[1], reverse=True)
