...
cuda_info = {}
    ...
    def _create_hash_signature(self, data: Dict[str, Any]:
...
total_weight = 0
    ...
    def _export_pip_requirements(self, snapshot: EnvironmentSnapshot:
...
requirements = []
    ...
    def _export_conda_requirements(self, snapshot: EnvironmentSnapshot:
    ...
    def _export_poetry_requirements(self, snapshot: EnvironmentSnapshot:
...
"""
    ...
    def _export_pipenv_requirements(self, snapshot: EnvironmentSnapshot:
