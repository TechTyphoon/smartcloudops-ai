...
try:
    ...
    from app.ai_handler import ai_handler as FlexibleAIHandler
...
def get_chatops_logs():
    ...
    try:
        ...
        try:
            ...
            logs = log_retriever.get_recent_logs(hours=24)
...
def manage_conversation():
    ...
    try:
        ...
        try:
            conversation_manager.add_exchange(message, "Response pending")
