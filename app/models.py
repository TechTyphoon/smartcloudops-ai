...
class User(Base):
    ...
    remediation_actions = relationship("RemediationAction", back_populates="executed_by_user")
...
class Anomaly(Base):
    ...
    metrics_data = Column(JSON, nullable=True)  # Store the metrics that triggered the anomaly
...
class RemediationAction(Base):
    ...
    action_type = Column(String(50), nullable=False)  # 'scale_up', 'scale_down', 'restart_service', 'cleanup_disk', 'custom'
