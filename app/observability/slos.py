...
class SLOManager:
    ...
    def _setup_default_slos(self):
        ...
        db_latency_slo = SLO(            name="database_latency",
        ...
        # API Error Rate SLO
        api_error_slo = SLO(            name="api_error_rate",
        ...
        throughput_slo = SLO(            name="request_throughput",
        ...
        saturation_slo = SLO(            name="resource_saturation",
