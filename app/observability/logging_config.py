...
class CorrelationJSONFormatter(pythonjsonlogger.jsonlogger.JsonFormatter):
...
def setup_logging(log_level: str = 'INFO', log_format: str = 'json') -> None:
    ...
    if log_format == 'json':
        ...
        format_string = '[%(asctime)s] %(levelname)s [%(correlation_id)s] in %(name)s: %(message)s'
...
def log_business_event(logger: logging.Logger, event_type: str, entity_type: str, entity_id: str, **kwargs) -> None:
    """
...
def log_security_event(logger: logging.Logger, event_type: str, severity: str, **kwargs) -> None:
    """
