...
def get_slo_status_endpoint():
    ...
    try:
        ...
        logger.error("Error getting SLO status: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
...
def get_specific_slo_status(slo_name: str):
    ...
    try:
        ...
        logger.error("Error getting SLO status for {slo_name}: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
...
def get_error_budget():
    ...
    try:
        ...
        logger.error("Error getting error budget: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
...
def get_slo_history():
    ...
    try:
        ...
        history_data = [        end_date = datetime.utcnow()
        ...
        logger.error("Error getting SLO history: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
...
def get_slo_trends():
    ...
    try:
        ...
        logger.error("Error getting SLO trends: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
...
def get_slo_alerts():
    ...
    try:
        ...
        logger.error("Error getting SLO alerts: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
    ...
    try:
        ...
        for slo_name, status in slo_status.items():
            if "error" not in status:
                ...
                metrics.append('slo_error_budget{{slo="{slo_name}"}} {status.get("error_budget", 0)} {timestamp}')
        ...
        metrics.append('slo_summary_total {total_count} {timestamp}')
        
        return "\n".join(metrics), 200, {"Content-Type": CONTENT_TYPE_LATEST}
    except Exception as e:
        logger.error("Error getting SLO metrics: {e}")
        return "# Error getting SLO metrics: {e}", 500, {"Content-Type": "text/plain"}
...
def slo_health_check():
    ...
    try:
        ...
        logger.error("Error in SLO health check: {e}")
        return jsonify({
            "status": "error",
            "data": None,
            "error": str(e),
