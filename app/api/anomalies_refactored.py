...
def get_anomalies():
    ...
    try:
        ...
        return ()
            jsonify({"status": "error", "message": f"Failed to retrieve anomaly: {str(e)}"}
            ),
            500)
        ...
        new_anomaly = anomaly_service.create_anomaly(data)
            ...
            return ()
            jsonify({"status": "error", "message": f"Failed to create anomaly: {str(e)}"}
            ),
            500)
            ...
            200)
                ...
                return ()
            jsonify({"status": "error", "message": f"Failed to update anomaly: {str(e)}"}
            ),
            500)
                ...
                404)
                    ...
                    return ()
                    jsonify({"status": "error", "message": f"Failed to delete anomaly: {str(e)}"}
                    ),
                    500)
                    ...
                    "message": f"Failed to acknowledge anomaly: {str(e)}",
                        ...
                        "message": f"Anomaly with ID {anomaly_id} not found",
                            ...
                            return ()
                            jsonify({"status": "error", "message": f"Failed to resolve anomaly: {str(e)}"}
                            ),
                            500)
