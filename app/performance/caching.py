...
class CacheManager:
    ...
    def create_cache(self, name: str, **kwargs) -> LRUCache:
        with self._lock:
...
def cached(cache_name: str = 'api_responses', 
    ...
    def warm_experiments_cache(mlops_service):
        ...
        try:
            ...
            if cache:
                ...
                logger.info(f"Warmed experiments cache with {len(experiments.get('experiments', []))} entries")
        except Exception as e:
    ...
    def warm_models_cache(mlops_service):
        ...
        try:
            ...
            if cache:
                ...
                logger.info(f"Warmed models cache with {len(models.get('models', []))} entries")
        except Exception as e:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                cache_performance_monitor.record_operation(cache_name, operation, duration)
