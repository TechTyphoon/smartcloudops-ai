...
from .caching import cache_manager, cached, cache_performance_monitor
...
class PerformanceCollector:
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'database': get_database().get_performance_report() if get_database() else {}
        }
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if hasattr(result, 'headers'):
                ...
                result.headers['X-Rate-Limit-Remaining'] = str(rate_limiter.get_remaining(client_ip))
