...
class MLService:
    ...
    def train_model(self, training_config: Dict) -> Dict:
        ...
        if training_config["algorithm"] not in valid_algorithms:
            raise ValueError()
                "Invalid algorithm. Must be one of: {', '.join(valid_algorithms)}"
            )
    ...
    def get_training_jobs(self) -> Dict:
        ...
        return {            "training_jobs": self.mock_training_jobs,
    ...
    def get_datasets(self) -> Dict:
        ...
        "
        return {            "datasets": self.mock_datasets,
    ...
    def deploy_model()
        ...
        valid_models = [            "anomaly_detector_v1",
