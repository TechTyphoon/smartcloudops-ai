        ...
        return jsonify({
            ...
            'data': {
                'tester': {
                    ...
                    'testing_scenarios': [s.value for s in tester.testing_scenarios],
                    'created_at': tester.created_at.isoformat(),
                    'last_active': tester.last_active.isoformat() if tester.last_active else None,
...
def test_notification():
    ...
    try:
        ...
        # Test notification
        success = beta_manager.test_notification(tester, data.get('message', 'Test notification'))
