    ...
    def process_query(self, query: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.conversation_history:
                ...
                messages = [{"role": "system", "content": self.system_prompt + context_prompt}] + recent_history + [{"role": "user", "content": sanitized_query}]
            ...
            if result['status'] == 'success':
                ...
                logger.info(f"Successfully processed query with {self.provider_name}: {sanitized_query[:50]}...")
